...
def caesar_cipher(message, shift):
    ...
    for char2 in char_list:
        ...
        counter1 = alphabet.count(upper_char)
        
        if counter1 > 0:
            counter2 = alphabet.count(char2)
            ...
            #Placed this if ever message had lowercase letters
            #Then saw that message is supposed to be only made up of uppercase letters
            '''elif counter2 == 0:
                caesar_index = alphabet.index(upper_char) + shift
                caesar_letter = alphabet[caesar_index]
                final_letter = caesar_letter.lower()
                caesar_list.append(final_letter)'''
